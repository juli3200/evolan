...
// general settings
pub const GENOME_LENGTH: usize = 64; // length of genomes
pub const INNER_LAYERS: usize = 2; // max val 3; because of gene generation (more bites assigned to the index bits)
pub const OUTPUT_LAYER: usize = INNER_LAYERS + 1;
pub const INNER_NEURONS: usize = 4; // inner neurons per inner layer
pub const MUTATION_ENABLED: bool = true; // used for performance 
pub const MUTATION_RATE: f64 = 0.005; // mutation rate of the genes (one hexadecimal letter will be changed)
